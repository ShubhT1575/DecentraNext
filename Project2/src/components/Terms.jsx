            ...
            <div className="card-body p-4">
              ...
              <ul className="terms-list list-unstyled">
                <li>
                  ...
                  <p className="mb-0">
                    Welcome to Core Crowd, a decentralized platform that
                ...
                <li>
                  ...
                  <p className="mb-0">
                    Core Crowd is a decentralized platform that facilitates
                ...
                <li>
                  ...
                  <p className="mb-0">
                    Core Crowd is not responsible for ensuring or guaranteeing
                ...
                <li>
                  ...
                  <p className="mb-0">
                    Core Crowd does not endorse, verify, or take responsibility
                ...
                <li>
                  ...
                  <p className="mb-0">
                    As a decentralized platform, Core Crowd operates without
                ...
                <li>
                  ...
                  <span className="fs-6 text-primary3">
                    Core Crowd is not liable for any loss, damage, or claims
                ...
                <li>
                  ...
                  <p className="mb-0">
                    Core Crowd reserves the right to modify or update these
