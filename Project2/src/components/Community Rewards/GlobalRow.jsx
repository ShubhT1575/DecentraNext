...
function CoreBody() {
  ...
  const getGlobalIncome = async () => {
    try {
      const response = await axios.get(apiUrl + "/getGlobalIncomeList", {
        params: {
          address: address,
          page: currentPage,
        },
      ...
      <div className="col-xl-12">
        <div className="card custom-card overflow-hidden">
          <div className="card-header justify-content-between">
            <div className="card-title">Community Rewards Data</div>
          </div>
          ...
          <div className="card-footer pagination-body">
            <div className="d-flex align-items-center justify-content-between">
              <div>Showing {GlobalIncome?.length || 0} Community Rewards</div>
              <div>
                <nav
                ...
                >
                  <ul className="pagination mb-0">
                    ...
                    >
{/* <button class="btn btn-success ">prvce</button> */}
                      Prev
                    </button>
